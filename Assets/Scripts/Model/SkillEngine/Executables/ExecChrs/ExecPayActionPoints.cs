...
public class ExecPaySkillPoints : ExecChr {
    ...
    public ExecPaySkillPoints(Chr _chrSource, Chr _chrTarget, Skill _skillUsing) : base(_chrSource, _chrTarget) {
        skillUsing = _skillUsing;
    }

    public ExecPaySkillPoints(ExecPaySkillPoints other) : base(other) {
        skillUsing = other.skillUsing;
    }
}
