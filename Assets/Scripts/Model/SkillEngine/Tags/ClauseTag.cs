...
public abstract class ClauseTag<T> {
    ...
    // This is mainly relevant for skills (channels) that could have a window between selection and execution, 
    // where the selected target becomes invalid at the time of execution.  This means that the skill needs to decide
