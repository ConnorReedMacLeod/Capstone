...
public static class SelectionSerializer {
    ...
    public class SelectionChr {
        ...
        public SelectionChr(Chr _chrOwner, int nSerialized) {
            chrOwner = _chrOwner;
    ...
    public class SelectionAction {
        ...
        public SelectionAction(Chr _chrOwner, int nSerialized) {
            chrOwner = _chrOwner;
            actUsed = DeserializeAction(chrOwner, GetByte(0, nSerialized));
            chrSelected = DeserializeChr(GetByte(1, nSerialized));
    ...
    public class SelectionSpecial {
        ...
        public SelectionSpecial(Chr _chrOwner, int nSerialized) {
            chrOwner = _chrOwner;
            actUsed = DeserializeAction(chrOwner, GetByte(0, nSerialized));
