...
public class ExecTurnBan : ExecPlayer {
    ...
    public override void ExecuteEffect() {
        ...
        sLabel = "Player " + plyrTarget.name + ", ban a character";
        fDelay = ContTurns.fDelayBan;

    }

    public ExecTurnBan(Chr _chrSource, Player _plyrTarget) : base(_chrSource, _plyrTarget) {

    }

    public ExecTurnBan(ExecTurnBan other) : base(other) {
