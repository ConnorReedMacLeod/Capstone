...
public class ExecTurnDraft : ExecPlayer {
    ...
    public override void ExecuteEffect() {
        ...
        sLabel = "Player " + plyrTarget.name + ", draft a character";
        fDelay = ContTurns.fDelayDraftPick;

    }

    public ExecTurnDraft(Chr _chrSource, Player _plyrTarget) : base(_chrSource, _plyrTarget) {

    }

    public ExecTurnDraft(ExecTurnDraft other) : base(other) {
