...
public class ExecTurnLoadoutSetup : Executable {
    ...
    public override void ExecuteEffect() {
        ...
        sLabel = "Setup your loadouts for your characters";
        fDelay = ContTurns.fDelayLoadoutSetup;

    }


    public ExecTurnLoadoutSetup(Chr _chrSource) : base(_chrSource) {

    }

    public ExecTurnLoadoutSetup(ExecTurnLoadoutSetup other) : base(other) {
